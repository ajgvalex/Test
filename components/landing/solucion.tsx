...
const features = [
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="3" y="2" width="14" height="16" rx="2" stroke="#185FA5" strokeWidth="1.5" />
        <path d="M7 7h6M7 10h6M7 13h4" stroke="#185FA5" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
    title: "Recibos digitales para cada empleado",
    description:
      "Cada quincena, tu equipo tiene su recibo de pago detallado. Menos preguntas, menos WhatsApps, menos tiempo explicando descuentos.",
  },
];
